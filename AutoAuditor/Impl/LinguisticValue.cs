...
namespace AutoAuditor.Impl.Models
{
    public static class LinguisticValue
    {
        public static double GetValue(AnswerLvl meaning, CategorieLvl lvl)
        {
            ...
            //if (lvl.Equals(CategorieLvl.Critical))
            //    return Critical(meaning);
            //else if (lvl.Equals(CategorieLvl.VeryImportant))
            //    return VeryImportant(meaning);
            //else if (lvl.Equals(CategorieLvl.Important))
            //    return Important(meaning);
            //else if (lvl.Equals(CategorieLvl.Minor))
            //    return Minor(meaning);
            //else if (lvl.Equals(CategorieLvl.Unknown))
            //    return 0.0;
